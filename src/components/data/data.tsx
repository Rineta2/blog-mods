...
export const dataPage = [
  {
    ...
    desc: "TikTok Pro Mods mengacu pada versi modifikasi dari aplikasi TikTok yang dikembangkan oleh pihak ketiga. Modifikasi ini biasanya memiliki beberapa fitur tambahan yang tidak tersedia dalam aplikasi resmi TikTok",
    date: "Juni, 25 2024",
    ...
    slugDetails: [
      {
        ...
        category: "Aplikasi",
        title: "Spotify Pro Mods",
        desc: "Spotify Pro Mods adalah modifikasi dari aplikasi Spotify resmi yang dikembangkan oleh pihak ketiga. Modifikasi ini biasanya menawarkan fitur tambahan yang tidak tersedia dalam aplikasi resmi Spotify, seperti:",
        name: "Update",
        date: "Juni, 25 2024",
        fiturname: "Fitur",
        fiturlist: [
